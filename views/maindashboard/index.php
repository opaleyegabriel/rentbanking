                                                ...
                                                <div class="card-inner">
                                                    <div class="nk-iv-wg2">
                                                        <div class="nk-iv-wg2-title">
                                                            <h6 class="title">
                                                                Total Amount Paid <em class="icon ni ni-info"></em>
                                                            </h6>
                                                        </div>
                                                        <div class="nk-iv-wg2-text">
                                                            <div class="nk-iv-wg2-amount">
                                                                <?php echo '₦'.number_format( $allpayments, 2).'k' ?>
                                                                <span class="change up">
                                                                    <span class="sign"></span>
                                                                     <?php echo $lastmonth; ?> / <?php echo $monthtopay; ?>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="nk-wg-card is-s1 card card-bordered">
                                                <div class="card-inner">
                                                    <div class="nk-iv-wg2">
                                                        <div class="nk-iv-wg2-title">
                                                            <h6 class="title">
                                                                Total Rent plan <em class="icon ni ni-info"></em>
                                                            </h6>
                                                        </div>
                                                        <div class="nk-iv-wg2-text">
                                                            <div class="nk-iv-wg2-amount">
                                                              <?php echo '₦'.number_format( $totalrentplan, 2).'k' ?>
                                                                <span class="change up">
                                                                    <span class="sign"></span>
                                                                     <?php echo $lastmonth; ?> / <?php echo $monthtopay; ?>
                                                                </span>
                                            ...
                                            <div class="nk-wg-card is-s3 card card-bordered">
                                                <div class="card-inner">
                                                    <div class="nk-iv-wg2">
                                                        <div class="nk-iv-wg2-title">
                                                            <h6 class="title">
                                                                Total To Contribute <em class="icon ni ni-info"></em>
                                                            </h6>
                                                        </div>
                                                        <div class="nk-iv-wg2-text">
                                                            <div class="nk-iv-wg2-amount">
                                                              <?php echo '₦'.number_format( $total2contribute, 2).'k' ?>
                                                                <span class="change up">
                                                                    <span class="sign"></span>
                                                                     <?php echo $lastmonth; ?> / <?php echo $monthtopay; ?>
                                                                </span>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="nk-wg-card card card-bordered h-100">
                                                <div class="card-inner h-100">
                                                    <div class="nk-iv-wg2">
                                                        <div class="nk-iv-wg2-title">
                                                            <h6 class="title">Active Month Account</h6>
                                                        </div>
                                                        <div class="nk-iv-wg2-text">
                                                            <div class="nk-iv-wg2-amount ui-v2"><?php echo $totalmonthpay; ?></div>
                                                            <form class="" action="<?php echo URL; ?>maindashboard/savepayment" method="post" enctype="multipart/form-data">
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                  <input type="hidden" name="activeamount" value="<?php echo $totalmonthpay; ?>">
                                                                  <input type="hidden" name="MA" value="<?php echo $monthlypayment; ?>">
                                                                    <input type="number" min="2000" class="form-control form-control-xl form-control-outlined" id="outlined-normal" name="deposit" required>
                                                                    <label class="form-label-outlined" for="outlined-normal">Enter Amount To Pay</label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <ul class="nk-iv-wg2-list">
                                                              <?php
                                                              foreach ($this->transactionaccumulation as $key => $value) {
                                                                // code...
                                                                $cr=$value["cr"];
                                                                $trndate=$value["trndate"];
                                                                $endmonth=date('d-m-Y',strtotime($value['endmonth']));
                                                                echo "<li>";
                                                               ...
                                                               ?>
                                                                <li class="total">
                                                                    ...
                                                                    <span class="item-value"><?php  echo "" ."₦".number_format( $totalmonthpay)."k".""; ?></span>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="nk-wg-card is-s3 card card-bordered">
                                                <div class="card-inner">
                                                    <div class="nk-iv-wg2">
                                                        <div class="nk-iv-wg2-title">
                                                            <h6 class="title">
                                                                End Date of Current Active Month <em class="icon ni ni-info"></em>
                                                            </h6>
                                                        </div>
                                                        <div class="nk-iv-wg2-text">
                                                            <div class="nk-iv-wg2-amount">
