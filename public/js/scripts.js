...
!function(p, u) {
    ...
    p.TGL.content = function(t, e) {
        ...
        t.on("click", function(t) {
            r = this,
            p.Toggle.trigger(u(this).data("target"), c),
            t.preventDefault()
        }),
        l.on("mouseup", function(t) {
            ...
            s = u(".modal"),
            e.is(t.target) || 0 !== e.has(t.target).length || n.is(t.target) || 0 !== n.has(t.target).length || a.is(t.target) || 0 !== a.has(t.target).length || i.is(t.target) || 0 !== i.has(t.target).length || o.is(t.target) || 0 !== o.has(t.target).length || s.is(t.target) || 0 !== s.has(t.target).length || (p.Toggle.removed(e.data("target"), c),
            r = !1))
        }),
        s.on("resize", function() {
            n.each(function() {
                var t = u(this).data("content")
                  ...
                  , e = d[e];
                p.Win.width > e && p.Toggle.removed(t, c)
            })
        })
    }
    ,
    ...
    p.TGL.ddmenu = function(t, e) {
        var t = t || ".nk-menu-toggle"
          ...
          , a = e ? f(n, e) : n;
        u(t).on("click", function(t) {
            p.Win.width < d.lg && p.Toggle.dropMenu(u(this), a),
            t.preventDefault()
        })
    }
    ,
