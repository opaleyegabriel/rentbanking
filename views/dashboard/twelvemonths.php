<body class="nk-body npc-invest bg-lighter ">
                  ...
                  <div class="nk-header-wrap">
                      ...
                      <div class="nk-header-brand">
                          <a href="/demo6/index.html" class="logo-link">
                              <img class="logo-light logo-img" src="<?php echo URL; ?>public/images/logo.png"  alt="logo">
                              <img class="logo-dark logo-img" src="<?php echo URL; ?>public/images/logo-dark.png"  alt="logo-dark">
                          ...
                          <ul class="nk-menu nk-menu-main">
                              ...
                              <li class="nk-menu-item active has-sub">
                                  ...
                                  <ul class="nk-menu-sub">
                                      ...
                                      <li class="nk-menu-item">
                                          <a href="/demo6/invest/invest-form.html" class="nk-menu-link">
                                              <span class="nk-menu-text">Investment Process</span>
                                          </a>
                                      </li>
                                      <li class="nk-menu-item">
                                          <a href="/demo6/invest/scheme-details.html" class="nk-menu-link">
                                              <span class="nk-menu-text">Investment Details</span>
                                          </a>
                                      </li>
                                      <li class="nk-menu-item">
                                          <a href="/demo6/invest/kyc-application.html" class="nk-menu-link">
                                              <span class="nk-menu-text">KYC - Get Started</span>
                                          </a>
                                      </li>
                                      <li class="nk-menu-item">
                                          <a href="/demo6/invest/kyc-form.html" class="nk-menu-link">
                                              <span class="nk-menu-text">KYC - Application Form</span>
                                          </a>
                                      </li>
                                      <li class="nk-menu-item">
                                          <a href="/demo6/index.html" class="nk-menu-link">
                                              <span class="nk-menu-text">
                                                  Main Dashboard <em class="icon ni ni-external"></em>
                                              </span>
                                          </a>
                                      </li>
                                      <li class="nk-menu-item">
                                          <a href="/demo6/components.html" class="nk-menu-link">
                                              <span class="nk-menu-text">
                                                  All Components <em class="icon ni ni-external"></em>
                                              </span>
                                          </a>
                                      </li>
                                  </ul>
                              ...
                              <li class="dropdown language-dropdown d-none d-sm-flex me-n1">
                                  <a href="#" class="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                                      <div class="quick-icon">
                                          <img class="icon" src="<?php echo URL; ?>public/images/english-sq.png" alt="">
                                      </div>
                                  </a>
                                      ...
                                      <ul class="language-list">
                                          <li>
                                              <a href="#" class="language-item">
                                                  <img src="<?php echo URL; ?>public/images/english.png" alt="" class="language-flag">
                                                  <span class="language-name">English</span>
                                              </a>
                                          </li>
                                          <li>
                                              <a href="#" class="language-item">
                                                  <img src="<?php echo URL; ?>public/images/spanish.png" alt="" class="language-flag">
                                                  <span class="language-name">Español</span>
                                              </a>
                                          </li>
                                          <li>
                                              <a href="#" class="language-item">
                                                  <img src="<?php echo URL; ?>public/images/french.png" alt="" class="language-flag">
                                                  <span class="language-name">Français</span>
                                              </a>
                                          </li>
                                          <li>
                                              <a href="#" class="language-item">
                                                  <img src="<?php echo URL; ?>public/images/turkey.png" alt="" class="language-flag">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1 is-light">
                                      ...
                                      <div class="dropdown-inner user-account-info">
                                          ...
                                          <div class="user-balance">
                                              1,494.23 <small class="currency currency-usd">USD</small>
                                          </div>
                                          <div class="user-balance-sub">
                                              Locked
                                              <span>
                                                  15,495.39 <span class="currency currency-usd">USD</span>
                                              </span>
                                          </div>
                                          <a href="#" class="link">
                                      ...
                                      <div class="dropdown-inner">
                                          <ul class="link-list">
                                              ...
                                              <li>
                                                  <a href="/demo6/invest/profile-activity.html">
                                            ...
                                            <div class="nk-kycfm-content">
                                                ...
                                                <div class="nk-kycfm-upload">
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-sm-4 d-none d-sm-block">
                                                            <div class="mx-md-4">
                                                                <img src="/demo6/images/icons/id-front.svg" alt="ID Front">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="nk-kycfm-upload">
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-sm-4 d-none d-sm-block">
                                                            <div class="mx-md-4">
                                                                <img src="/demo6/images/icons/id-back.svg" alt="ID Back">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-control custom-control-xs custom-checkbox">
                                                        ...
                                                        <label class="custom-control-label" for="tc-agree">
                                                            I Have Read The <a href="#">Terms Of Condition</a>
                        ...
                        <ul class="country-list text-center gy-2">
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/arg.png" alt="" class="country-flag">
                                    <span class="country-name">Argentina</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/aus.png" alt="" class="country-flag">
                                    <span class="country-name">Australia</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/bangladesh.png" alt="" class="country-flag">
                                    <span class="country-name">Bangladesh</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/canada.png" alt="" class="country-flag">
                            ...
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/china.png" alt="" class="country-flag">
                            ...
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/french.png" alt="" class="country-flag">
                                    <span class="country-name">France</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/germany.png" alt="" class="country-flag">
                                    <span class="country-name">Germany</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/iran.png" alt="" class="country-flag">
                                    <span class="country-name">Iran</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/italy.png" alt="" class="country-flag">
                                    <span class="country-name">Italy</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/mexico.png" alt="" class="country-flag">
                                    <span class="country-name">México</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/philipine.png" alt="" class="country-flag">
                                    <span class="country-name">Philippines</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/portugal.png" alt="" class="country-flag">
                                    <span class="country-name">Portugal</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/s-africa.png" alt="" class="country-flag">
                                    <span class="country-name">South Africa</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/spanish.png" alt="" class="country-flag">
                                    <span class="country-name">Spain</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/switzerland.png" alt="" class="country-flag">
                                    <span class="country-name">Switzerland</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/uk.png" alt="" class="country-flag">
                                    <span class="country-name">United Kingdom</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="country-item">
                                    <img src="<?php echo URL; ?>public/images/english.png" alt="" class="country-flag">
        ...
        <div class="nk-demo-list" data-simplebar>
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo1/index.html">
                    <div class="nk-demo-image bg-blue">
                        <img class="bg-purple" src="<?php echo URL; ?>public/images/landing/layout-1d.jpg" srcset="<?php echo URL; ?>public/images/landing/layout-1d2x.jpg 2x" alt="Demo Layout 1">
                    </div>
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo2/index.html">
                    <div class="nk-demo-image bg-purple">
                        <img src="<?php echo URL; ?>public/images/landing/layout-2d.jpg" srcset="<?php echo URL; ?>public/images/landing/layout-2d2x.jpg 2x" alt="Demo Layout 2">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo3/index.html">
                    <div class="nk-demo-image bg-success">
                        <img src="<?php echo URL; ?>public/images/landing/layout-3d.jpg" srcset="<?php echo URL; ?>public/images/landing/layout-3d2x.jpg 2x" alt="Demo Layout 3">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo4/index.html">
                    <div class="nk-demo-image bg-indigo">
                        <img src="<?php echo URL; ?>public/images/landing/layout-4d.jpg" srcset="<?php echo URL; ?>public/images/landing/layout-4d2x.jpg 2x" alt="Demo Layout 4">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo5/index.html">
                    <div class="nk-demo-image bg-orange">
                        <img src="<?php echo URL; ?>public/images/landing/layout-5d.jpg" srcset="<?php echo URL; ?>public/images/landing/layout-5d2x.jpg 2x" alt="Demo Layout 5">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo6/index.html">
                    <div class="nk-demo-image bg-purple">
                        <img src="<?php echo URL; ?>public/images/landing/layout-6d.jpg" srcset="<?php echo URL; ?>public/images/landing/layout-6d2x.jpg 2x" alt="Demo Layout 6">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo7/index.html">
                    <div class="nk-demo-image bg-teal">
                        <img src="<?php echo URL; ?>public/images/landing/layout-7d.jpg" srcset="<?php echo URL; ?>public/images/landing/layout-7d2x.jpg 2x" alt="Demo Layout 7">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo8/index.html">
                    <div class="nk-demo-image bg-azure">
                        <img src="<?php echo URL; ?>public/images/landing/layout-8d.jpg" srcset="<?php echo URL; ?>public/images/landing/layout-8d2x.jpg 2x" alt="Demo Layout 8">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/landing/index.html">
                    <div class="nk-demo-image bg-red">
                        <img src="<?php echo URL; ?>public/images/landing/main-landing.jpg" srcset="<?php echo URL; ?>public/images/landing/main-landing2x.jpg 2x" alt="Landing Page">
                    </div>
                    <span class="nk-demo-title">
        ...
        <div class="nk-demo-list" data-simplebar>
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo2/ecommerce/index.html">
                    <div class="nk-demo-image bg-dark">
                        <img src="<?php echo URL; ?>public/images/landing/demo-ecommerce.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-ecommerce2x.jpg 2x" alt="Ecommerce">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo2/lms/index.html">
                    <div class="nk-demo-image bg-danger">
                        <img src="<?php echo URL; ?>public/images/landing/demo-lms.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-lms2x.jpg 2x" alt="LMS">
                    </div>
                    <span class="nk-demo-title">
                        <em class="text-primary">Demo2</em>
                        <br>
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo1/crm/index.html">
                    <div class="nk-demo-image bg-info">
                        <img src="<?php echo URL; ?>public/images/landing/demo-crm.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-crm2x.jpg 2x" alt="CRM / Customer Relationship">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo7/hospital/index.html">
                    <div class="nk-demo-image bg-indigo">
                        <img src="<?php echo URL; ?>public/images/landing/demo-hospital.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-hospital2x.jpg 2x" alt="Hospital Managemen">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo1/hotel/index.html">
                    <div class="nk-demo-image bg-pink">
                        <img src="<?php echo URL; ?>public/images/landing/demo-hotel.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-hotel2x.jpg 2x" alt="Hotel Managemen">
                    </div>
                    <span class="nk-demo-title">
                        <em class="text-primary">Demo1</em>
                        <br>
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo3/cms/index.html">
                    <div class="nk-demo-image bg-dark">
                        <img src="<?php echo URL; ?>public/images/landing/demo-cms.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-cms2x.jpg 2x" alt="cms">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo5/crypto/index.html">
                    <div class="nk-demo-image bg-warning">
                        <img src="<?php echo URL; ?>public/images/landing/demo-buysell.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-buysell2x.jpg 2x" alt="Crypto BuySell / Wallet">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.netindex.html">
                    <div class="nk-demo-image bg-indigo">
                        <img src="<?php echo URL; ?>public/images/landing/demo-invest.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-invest2x.jpg 2x" alt="HYIP / Investment">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo3/apps/file-manager.html">
                    <div class="nk-demo-image bg-purple">
                        <img src="<?php echo URL; ?>public/images/landing/demo-file-manager.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-file-manager2x.jpg 2x" alt="File Manager">
                    </div>
                    <span class="nk-demo-title">
                        <em class="text-primary">Demo3</em>
                        <br>
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo4/subscription/index.html">
                    <div class="nk-demo-image bg-primary">
                        <img src="<?php echo URL; ?>public/images/landing/demo-subscription.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-subscription2x.jpg 2x" alt="SAAS / Subscription">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/covid/index.html">
                    <div class="nk-demo-image bg-danger">
                        <img src="<?php echo URL; ?>public/images/landing/demo-covid19.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-covid192x.jpg 2x" alt="Covid Situation">
                    </div>
                    <span class="nk-demo-title">
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo3/apps/messages.html">
                    <div class="nk-demo-image bg-success">
                        <img src="<?php echo URL; ?>public/images/landing/demo-messages.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-messages2x.jpg 2x" alt="Messages">
                    </div>
                    <span class="nk-demo-title">
                        <em class="text-primary">Demo3</em>
                        <br>
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo3/apps/mailbox.html">
                    <div class="nk-demo-image bg-purple">
                        <img src="<?php echo URL; ?>public/images/landing/demo-inbox.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-inbox2x.jpg 2x" alt="Inbox">
                    </div>
                    <span class="nk-demo-title">
                        <em class="text-primary">Demo3</em>
                        <br>
            ...
            <div class="nk-demo-item">
                <a href="https://dashlite.net/demo3/apps/chats.html">
                    <div class="nk-demo-image bg-purple">
                        <img src="<?php echo URL; ?>public/images/landing/demo-chats.jpg" srcset="<?php echo URL; ?>public/images/landing/demo-chats2x.jpg 2x" alt="Chats / Messenger">
                    </div>
                    <span class="nk-demo-title">
                        <em class="text-primary">Demo3</em>
                        <br>
    ...
    <a class="pmo-st pmo-dark" target="_blank" href="https://softnio.com/get-early-access/">
        <div class="pmo-st-img">
            <img src="<?php echo URL; ?>public/images/landing/promo-investorm.png" alt="Investorm">
        </div>
